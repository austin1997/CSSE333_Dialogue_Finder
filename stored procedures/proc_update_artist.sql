...
CREATE PROCEDURE dbo.update_artist
(@Name nvarchar(50),
 @BDate date = NULL,
 @Gender char(1) = NULL,
...
begin
	...
	select @CurrentBDate = Birthday, @CurrentGender = Gender, @CurrentInfo = Info from Artist where Name = @Name
	if (@BDate is null)
	begin
...
BEGIN
	...
	PRINT 'An error occurred updating the artist ' + @Name + '.'
	RETURN(@Status)
END
ELSE
BEGIN
	-- Return 0 to the calling program to indicate success.
	PRINT 'The artist ' + @Name + ' was updated successfully.'
	RETURN(0)
END